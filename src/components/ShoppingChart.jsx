...
const ShoppingCart = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("storage", sync); // ✅ za drugi tab
    ...
    <>
      ...
      {isOpen && (
        <div className="fixed top-0 right-0 w-full sm:w-[400px] h-full bg-white shadow-lg z-50 p-4 overflow-y-auto">
          ...
          {cart.length === 0 ? (
            <p className="text-gray-600">Shopping cart is empty</p>
          ) : (
            <>
